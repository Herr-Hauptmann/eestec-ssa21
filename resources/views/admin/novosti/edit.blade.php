...
<div class="container-fluid pt-5 pl-5 izbornik">
    <div class="row">
        ...
        <div class="col-12 col-md-8 p-0 mt-5 mt-md-0 ml-md-3 border rounded border-secondary sadrzaj">
            ...
            @endif
            <form class="m-5" action="{{ route('novosti.update', $novost->id) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" id="datum" name="datum" value="{{ $novost->datum }}">
                    </div>
                    <div class="custom-file col-md-12 mt-4">
                        <input type="file" class="custom-file-input" id="slika" name="slika" 
                            accept="image/png, image/jpeg, image/jpg">
                        <label class="custom-file-label" for="slika">Promijeni postojeću sliku</label>
                    </div>
                    <div class="container">
                        <div class="row">
