...
<div class="container-fluid pt-5 pl-5 izbornik">
    <div class="row">
        ...
        <div class="col-12 col-md-8 p-0 mt-5 mt-md-0 ml-md-3 border rounded border-secondary sadrzaj">
            ...
            @endif
            <form class="m-5" action="{{ route('treneri.store') }}" method="POST"  enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="imeTrenera">Ime</label>
                        <input name="ime" type="text" class="form-control" id="imeTrenera" placeholder="Ime">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="prezimeTrenera">Prezime</label>
                        <input name="prezime" type="text" class="form-control" id="prezimeTrenera" placeholder="Prezime">
                    </div>
