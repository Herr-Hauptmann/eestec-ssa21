            ...
            <form class="m-5" action="{{ route('admin.izjave.spasavanje') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="imeParticipanta" placeholder="Ime participanta">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="prezime-participanta">Prezime</label>
                        <input type="text" class="form-control" id="prezimeParticipanta" placeholder="Prezime participanta">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="pozicija-opis">Izjava</label>
                        <textarea class="form-control" id="izjavaParticipanta" rows="3"></textarea>
                    </div>
                    <div class="custom-file col-md-12 mt-4">
                        <input type="file" class="custom-file-input" id="slikaParticipanta">
